...
def kitchen():
    print("destination=kitchen")
def bathroom():
    print("destination= bathroom")
def bedroom():
    print("destination is bedroom")
def game():
    print("destination is game room")
def loft():
    print("destination=loft")
def laundry():
    print("destination is laundry room")
def livingroom():
    print("destination is living room")
def pantry():
    print("destination is pantry")
def exit():
    start(f12)
